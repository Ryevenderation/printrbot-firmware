...
// You should use MINTEMP fors thermistor short/failure protection.
...
// default settings
#if defined(PB_MCF)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2020,94.6}
...
//#define falseAP_DISCOUNT_SMART_CONTROLLERLCD
